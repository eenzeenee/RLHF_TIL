...
model = LlamaForCausalLM.from_pretrained(
    ...
    device_map="cuda:0", # auto -> cuda:0 ## memory error 해결
)
...
if __name__ == '__main__':
    ...
    with open(file='/home/work/data00/result/no_finetune.pickle', mode='wb') as f:
        pickle.dump(tmp_result, f)
    print('finish dump no-finetuned test data')
